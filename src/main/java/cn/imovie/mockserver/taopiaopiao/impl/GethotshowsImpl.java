...
import cn.imovie.mockserver.taopiaopiao.controller.Gethotshows;
import cn.imovie.mockserver.util.MAPUtil;
...
@Service
public class GethotshowsImpl implements Gethotshows {
    ...
    public void Gethotshows(Map map, PrintWriter out){
        List<JSONObject> hot_filmObjects = new ArrayList<JSONObject>();

        String command="SELECT * FROM  tpp_film t where t.isplay='1'";
...
;
        ...
        hot_shows.put("hot_shows",mtop_cinema2);
